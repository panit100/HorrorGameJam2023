...
namespace FluffyUnderware.DevToolsEditor
{
    public static class DTToolbar
    {
        ...
        private const int PROJECTSPACE = 20;

        public static bool RecalcItemSize = true;
        public static bool MouseOverToolbarElement { get; private set; }

        private static Vector2[] _MaxItemDimension = new Vector2[4]; // each Orientation has it's own max. Dimension
        /// <summary>
        /// Starting position for each side
        /// </summary>
        private static Rect[] _InitialRects;
        /// <summary>
        /// Last item position for each side
        /// </summary>
        private static Rect[] _ItemRect;
        ...
        private static void Render(SceneView view)
        {
        ...
        private static Rect[] getInitialItemRect()
        {
            Rect[] res = new Rect[4];
        ...
        private static Rect advanceItemRect(DTToolbarItem lastItem, DTToolbarItem newItem, Vector2 newItemSize)
        {
            Rect itemRect;
            float space = 0;
        ...
        /// </summary>
        private static void calcMaxItemDimension()
        {
